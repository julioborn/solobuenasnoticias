...
export default function NewsCard({ news, featured = false }: NewsCardProps) {
  ...
  if (featured) {
    return (
      <Link href={`/noticias/${news.id}`} className="block h-full group">
        <article className="relative overflow-hidden bg-white border border-stone-200 hover:border-stone-400 transition-colors duration-200 flex flex-col sm:flex-row h-full min-h-[220px]">
          {news.is_featured && (
          ...
          <div className="flex flex-col justify-between p-5 flex-1 border-l border-stone-200">
            <div>
  ...
  return (
    <Link href={`/noticias/${news.id}`} className="block h-full group">
      <article className="overflow-hidden bg-white border border-stone-200 hover:border-stone-400 transition-colors duration-200 flex flex-col h-full">
        ...
        <div className="flex flex-col flex-1 p-4 border-t-2 border-stone-950">
          ...
          <div className="mt-auto flex items-center justify-between pt-3 border-t border-stone-100">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="text-[10px] text-stone-400 hover:text-stone-600 transition-colors uppercase tracking-wider"
              >
                Original ↗
              </a>
